  ...
  return (
    <nav className="bg-black py-9">
      <div className="container mx-auto px-4 flex justify-between items-center text-2xl">
        <h1 className="text-[#FF8C9E] text-3xl font-bold hover:text-[#C75B7A]">
          Website.
        </h1>
        ...
        <li className=" text-white border border-white list-none hover:bg-[#CA8787] rounded-xl py-3 px-6">
